...
public class CsoportMunkaSzamolas {
    ...
    public static void main(String[] args) {
        ...
        while (ujjatek) {
            ...
            int joszazalek = (helyes / 10) * 100;
            System.out.println("Ennyi lett jó:" + helyes + "/10" + " és ennyi százalékod lett: " + joszazalek+"%.");
            System.out.println("Akarsz új játékot?: ");
            String valasz = jel.nextLine();
            while (!(valasz.toLowerCase().equals("nem") || valasz.toLowerCase().equals("igen"))) {
                System.out.println("A válasz nem jó. Akarsz új játékot?: ");
                valasz = jel.nextLine();
            }
            if (valasz.toLowerCase().equals("igen")) {
                ujjatek = true;
            } else {
                ujjatek = false;
            }
